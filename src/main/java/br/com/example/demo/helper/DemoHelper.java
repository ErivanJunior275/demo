...
public class DemoHelper {
	...
	public ResponseEntity<ResponseDTO<AlunoResponseDTO>> mapearRetorno(String nome, ResponseDTO<AlunoResponseDTO> responseDTO) {
	...
	public ResponseEntity<ResponseDTO<AlunoDetalheResponseDTO>> mapearRetornoDetalhe(Integer id, ResponseDTO<AlunoDetalheResponseDTO> responseDTO) {
	...
	public ResponseEntity<ResponseDTO<AlunoResponseDTO>> atualizarAluno(Integer id, 
			AlunoRequestDTO alunoRequestDTO, ResponseDTO<AlunoResponseDTO> responseDTO) {
		Optional<Aluno> optionalAluno = alunoRepository.findById(id);
		if(optionalAluno.isPresent()) {
